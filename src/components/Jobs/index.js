...
class Jobs extends Component {
  state = {
    ...
    jobsLoadingStatus: dataFetchStatusConstants.initial,
  }
  ...
  getUserProfileData = async () => {
    ...
    if (response.ok) {
      ...
      this.setState({
        profileDetails,
        profileLoadingStatus: dataFetchStatusConstants.success,
      })
    } else {
  ...
  getJobsList = async () => {
    ...
    if (response.ok) {
      ...
      const {jobs} = data
      //   console.log(jobs)
      this.setState({jobs, jobsLoadingStatus: dataFetchStatusConstants.success})
    } else {
